  ...
  finalkval: [
    {
      ...
      song: 'Woman',
      songwriters: ['Dino Medanhodzic', 'Jimmy Jansson', 'Moa "Cazzi Opeia" Carlebecker', 'Thomas G:son'],
      bio: 'Jacqline är en sångerska som blev känd genom Idol 2021 där hon tog sig till finalen. Hon tog sig vidare från Deltävling 1 till Finalkvalet med popbantan "Woman".',
    },
    {
      id: 'fk-2',
      eventId: 'finalkval',
      ...
      song: 'Honey honey',
      songwriters: ['Gavin Jones', 'Pär Westerlund', 'Petter Tarland', 'Robin Bengtsson'],
      bio: 'Robin Bengtsson vann Melodifestivalen 2017 med "I Can\'t Go On" och representerade Sverige i Eurovision. Han tog sig vidare från Deltävling 2 till Finalkvalet.',
    },
    {
      id: 'fk-3',
      eventId: 'finalkval',
      ...
      song: 'Selfish',
      songwriters: ['Eva Jumatate', 'Herman Gardarfve', 'Marlene Strand', 'Ruth Lindegren'],
      bio: 'Eva Jumatate är bara 17 år gammal och en av tävlingens yngsta deltagare. Hon tog sig vidare från Deltävling 3 till Finalkvalet med den personliga låten "Selfish".',
    },
    {
      id: 'fk-4',
      eventId: 'finalkval',
      ...
      song: 'Dooset daram',
      songwriters: ['Anderz Wrethov', 'Jimmy "Joker" Thörnfeldt', 'Laurell Barker', 'Meira Omar'],
      bio: 'Meira Omar är en afghansk-svensk sångerska som blev känd genom Love Is Blind: Sweden. Hon tog sig vidare från Deltävling 4 till Finalkvalet med "Dooset daram".',
    },
  ],
  final: [
    {
      ...
      song: 'Half of me',
      songwriters: ['Andreas Werling', 'Karl Ivert', 'Kian Sang', 'Greczula'],
      bio: 'Greczula är en svensk-polsk artist och låtskrivare som gick direkt till final från Deltävling 1 med den kraftfulla balladen "Half of Me".',
    },
    {
      id: 'f-2',
      eventId: 'final',
      ...
      song: 'Iconic',
      songwriters: ['Dino Medanhodzic', 'Jimmy Jansson', 'Lina Hansson', 'Moa "Cazzi Opeia" Carlebecker', 'Thomas G:son'],
      bio: 'A-Teens är den ikoniska popgruppen från Stockholm som gick direkt till final från Deltävling 1. De gör comeback efter 20 år med sitt första nya material.',
    },
    {
      id: 'f-3',
      eventId: 'final',
      ...
      song: 'My system',
      songwriters: ['Audun Agnar', 'Emily Harbakk', 'Felicia', 'Julie Bergan', 'Theresa Rex'],
      bio: 'Felicia, även känd som Fröken Snusk, gick direkt till final från Deltävling 2 med house-influerade "My System".',
    },
    {
      id: 'f-4',
      eventId: 'final',
      ...
      song: 'Rakt in i elden',
      songwriters: ['Anderz Wrethov', 'Elin Wrethov', 'Kristofer Strandberg', 'Robert Skowronski'],
      bio: 'Brandsta City Släckers är ett rockband från Älvdalen som gick direkt till final från Deltävling 2 med energiska "Rakt in i elden".',
    },
    {
      id: 'f-5',
      eventId: 'final',
      ...
      song: "Viva l'amor",
      songwriters: ['Ali "Alibrorsh" Jammali', 'Anderz Wrethov', 'Dino Medanhodzic', 'Jimmy "Joker" Thörnfeldt', 'Sami Rekik'],
      bio: 'Medina är en Melodifestivalen-favorit som tog tredjeplats 2022 och andraplats 2024. Han gick direkt till final från Deltävling 3 med kärlekshyllningen "Viva l\'amor".',
    },
    {
      id: 'f-6',
      eventId: 'final',
      ...
      song: "Ain't today",
      songwriters: ['Dino Medanhodzic', 'Jimmy Jansson', 'Johanna "Dotter" Jansson', 'Saga Ludvigsson'],
      bio: 'Saga Ludvigsson är en återkommande Melodifestivalen-artist som gick direkt till final från Deltävling 3 med "Ain\'t Today", en låt om att lämna en stillastående relation.',
    },
    {
      id: 'f-7',
      eventId: 'final',
      ...
      song: 'Hollow',
      songwriters: ['Benjamin Jennebo', 'Chris Adam Hedman Sörbye', 'Per Bergquist', 'Philip Strand'],
      bio: 'Smash Into Pieces är ett rockband från Örebro bildat 2008 som gick direkt till final från Deltävling 4 med den kraftfulla "Hollow".',
    },
    {
      id: 'f-8',
      eventId: 'final',
      ...
      song: 'Eternity',
      songwriters: ['Cimberly-Malaika Wanyonyi', 'David Lindgren Zacharias', 'Dino Medanhodzic', 'Melanie Wehbe'],
      bio: 'Cimberly Wanyonyi vann Idol 2023 och hennes hit "Sången om Värmland" har över 10 miljoner streams. Hon gick direkt till final från Deltävling 4 med "Eternity".',
    },
  ],
};
